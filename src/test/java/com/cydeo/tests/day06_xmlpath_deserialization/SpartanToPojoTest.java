...
public class SpartanToPojoTest extends SpartanTestBase {
    ...
    public void spartanPojoTest(){
        ...
        //DE-SERIALIZATION convert from JSON to POJO object type. Jackson is doing all the work in the background
        //if Jackson is removed from dependencies as() will not be able to execute
